								...
								JobType.IO, 100, 74L), new Job("4", Priority.Medium,
										JobType.Computation, 1000, 54L), new Job("5", Priority.High,
												JobType.Computation, 350, 61L), new Job("6", Priority.Low,
														JobType.IO, 200, 32L), new Job("7", Priority.High,
																JobType.Computation, 700, 6L), new Job("8", Priority.Medium,
																		JobType.Computation, 600, 58L), new Job("9", Priority.High,
																				JobType.IO, 30, 48L), new Job("10", Priority.Low, JobType.IO,
																						20, 43L));
