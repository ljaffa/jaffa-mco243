...
public class PriorityJobScheduler extends Scheduler {

	private Comparator<Job> comparator;

	public PriorityJobScheduler(List<Job> jobs, Comparator<Job> comparator) {
		super(jobs);
	...
	public static void main(String[] args) {
		...
		PriorityJobScheduler scheduler = new PriorityJobScheduler(
				new ArrayList<Job>(jobs), new PriorityComparator());
		scheduler.run();
