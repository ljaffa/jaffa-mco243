	...
	public static void main(String[] args) {
		List<Job> jobs = Arrays.asList(new Job("1", Priority.High,
				JobType.Computation, 100), new Job("2", Priority.Low,
						JobType.Computation, 200), new Job("3", Priority.Medium,
								JobType.IO, 100), new Job("4", Priority.Medium,
										JobType.Computation, 1000), new Job("5", Priority.High,
												JobType.Computation, 350), new Job("6", Priority.Low,
														JobType.IO, 20), new Job("7", Priority.High, JobType.IO, 30),
														new Job("8", Priority.Medium, JobType.Computation, 600),
														new Job("9", Priority.Low, JobType.IO, 700), new Job("10",
																Priority.High, JobType.Computation, 200));
